...
import { fetchGalleryItems, fetchGalleryCategories, createTestimonial } from '../../api';
...
export default function AddTestimonial() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (galleryItemId) payload.gallery_item = galleryItemId;
      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl font-display font-bold">Add New Testimonial</h1>
              <p className="mt-1 text-gray-600">
                Share a story, optionally illustrated with an existing gallery photo or video
              </p>
            </div>
            <button
        ...
        {success && (
          <div className="mb-6 bg-green-50 p-4 rounded-lg flex items-center">
            ...
            <div>
              <p className="text-green-700 font-medium">Testimonial was successfully created!</p>
              <p className="text-green-600 text-sm">You can continue adding more or return to the list.</p>
            </div>
          </div>
        )}
          ...
          <div className="p-6">
            <div className="mb-6">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder="e.g. Cooperative Member"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows="4"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                  placeholder="What did this person say? (optional)"
                />
              </div>
            </div>

            {/* Assign an existing gallery photo/video */}
            <div className="mb-6">
              <h2 className="text-lg font-display font-medium text-gray-900 mb-4">Photo / Video (Optional)</h2>
              <p className="text-sm text-gray-500 mb-3">
                Assign an already-uploaded gallery item to this testimonial.
              </p>
              ...
              {selectedItem ? (
                ...
                <div className="bg-yellow-50 p-4 rounded-lg flex items-center">
                  ...
                  <p className="text-yellow-700 text-sm">
                    No gallery items yet — <a href="/dashboard/addGallery" className="underline">add one</a> first if you'd like to attach media.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-gray-500">
                {isActive ? 'This testimonial will be visible publicly' : 'This testimonial will be hidden'}
              </p>
            </div>
          </div>
